...
<?php echo Form::open(array("class"=>"form-horizontal")); ?>
	...
	<fieldset>
            <div class="control-group" style="font-size: 5px;">
                <div class="odd">
			<?php echo Form::label('Employee Id', 'Employee Id', array('class'=>'control-label')); ?>

			<div class="controls">
				<?php echo Form::input('Employee Id', Input::post('Employee Id', isset($employee) ? $employee->id : ''), array('class' => 'span4', 'placeholder'=>'Employee Id')); ?>
                        </div>
			</div>
            </div>
...
>>>>>>> 2ff2bf073ca146a4c4b4182307d90c7ef55ca320
                   ...
                   <div class="control-group">
                <div class="even">
			<?php echo Form::label('Blood Group','Blood Group', array('class'=>'control-label')); ?>

			<div class="controls">
				<?php echo Form::input('Blood Group', Input::post('Blood Group', isset($employee) ? $employee->blood_group : ''), array('class' => 'span4', 'placeholder'=>'Blood Group')); ?>
                        </div>
			</div>
            </div>
